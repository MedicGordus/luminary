...
public class BigIntegerUnitsOperator : BigIntegerOperator
{
    ...
    public BigIntegerUnitsOperator(BigInteger? _nullableValue, string? _nullableUnit) : base(_nullableValue, OperatorValueType.BigIntegerUnits)
    {
        NullableUnits = _nullableUnit;
    }
    ...
    public override OperatorValue? BooleanAnd(OperatorValue[]? _parameters)
    {
        ...
        BigInteger parameterValue = base.InheritableBooleanAnd(_parameters);

#nullable disable
        if (_parameters[0] is not BigIntegerUnitsOperator)
#nullable enable
        {
            throw new ArgumentException("Cannot booleanand when the parameter is not a bigintegerunits.");
        }

        var paramUnit = ((BigIntegerUnitsOperator)_parameters[0]).NullableUnits;
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableBitwiseMod(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableBitwiseRightShift(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableBitwiseXor(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableMathAdd(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableMathAverage(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableMathDivide(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableMathMultiply(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableMathPower(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableMathSubtract(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableBooleanOr(_parameters);
...
#nullable enable
    ...
    {
        // this does the nullable checks, etc. for us, on top of retrieving the value
        BigInteger parameterValue = base.InheritableBooleanNot(_parameters);
...
#nullable enable
    ...
    public new static OperatorValue BuildFromParameters(string[] _parameters)
    {
        ...
        if (BigInteger.TryParse(_parameters[0], out BigInteger value))
        {
            return new BigIntegerUnitsOperator(value, _parameters[1]);
        }
        else
        {
            throw new ArgumentException(
    ...
    public new static OperatorValue BuildFromString(string? _input)
    {
        ...
        (BigInteger bigIntegerValue, string bigIntegerUnits) = UnitHelper.ParseStringToBigIntegerUnits(_input);
        return new BigIntegerUnitsOperator(bigIntegerValue, bigIntegerUnits);
    }
